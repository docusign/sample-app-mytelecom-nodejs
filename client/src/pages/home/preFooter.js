      ...
      <div className="cta-links">
        <div className="resource-links">
          ...
          <div className="resource-link">
            <a className="resource-link" href={t('DocuSignLink')} target="_blank" rel="noopener noreferrer">
              {t('DocuSignLinkHeader')}
              <img src={arrow} alt="" />
            </a>
          </div>
          <div className="resource-link">
            <a className="resource-link" href={t('eSignatureSDKLink')} target="_blank" rel="noopener noreferrer">
              {t('eSignatureSDK')}
              <img src={arrow} alt="" />
            </a>
          </div>
          <div className="resource-link">
            <a className="resource-link" href={t('ClickSDKLink')} target="_blank" rel="noopener noreferrer">
              {t('ClickSDK')}
              <img src={arrow} alt="" />
            </a>
          </div>
